...
export default function Header() {
  ...
  const heroBackdropBlur = useTransform(
    progress,
    [0, 0.18, 1],
    ["0px", "8px", "8px"],
  );
  const pillBackdropBlur = useTransform(
    progress,
    [0, 0.18, 1],
    ["0px", "8px", "8px"],
  );
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          backdropFilter: useMotionTemplate`blur(${heroBackdropBlur})`,
        }}
      />
      <motion.div
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                backdropFilter: useMotionTemplate`blur(${pillBackdropBlur})`,
                borderRadius: barRadius,
              }}
            />
            {/* Content */}
            ...
            <div className="flex items-center">
              <Link
                href="/"
                className="flex items-center space-x-3 hover:opacity-90 transition-opacity pl-3 sm:pl-4"
              >
                <div className="relative group">
                  ...
                  <div className="relative rounded-xl p-1 bg-gradient-to-br from-white/80 to-gray-100/80 dark:from-white/10 dark:to-white/5 ring-1 ring-black/5 dark:ring-white/10 shadow-lg dark:shadow-black/20">
                    <img
                      src="/icon.png"
                      alt="Wit AI"
                      className={`h-8 sm:h-9 w-8 sm:w-9 rounded-lg transform group-hover:scale-110 transition-transform duration-300 ${
                        scrolled
            ...
            <div className="hidden md:flex items-center space-x-2 pr-2 sm:pr-4">
              <BezelButton variant="dark" onClick={() => setIsDemoOpen(true)}>
                Book a Demo
              </BezelButton>
            </div>
          ...
          <div className="md:hidden">
            <AnimateIn direction="down" distance={12}>
              <div
                className={`${
                  scrolled
                    ? "mx-3 mt-2 rounded-2xl shadow-lg ring-1 ring-black/5 bg-white text-zinc-900 dark:bg-neutral-900 dark:text-white dark:ring-white/10"
                    : ""
