        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            ...
            <div className="mt-3 text-center">
              <p className="text-xs text-gray-500 bg-gray-50 rounded-md px-3 py-1.5 inline-block">
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <blockquote className="text-xl md:text-2xl font-medium text-gray-900 leading-relaxed pl-6">
                "{testimonialText}"
              </blockquote>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-gray-600 text-sm">{authorRole}</div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-gray-200">
              <div className="flex items-center justify-between text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-600">GPA Improvement</div>
                </div>
              </div>
            </div>
          </div>
